...
import in.ashokit.db1.repositories.UserRepository;
import in.ashokit.db2.entities.Book;
import in.ashokit.db2.repositories.BookRepository;
...
public class DemoRestController {
	...
	public String addData2DB() {
		...
		bookRepository.saveAll(Stream.of(new Book(1, "Core Java", 100.00), new Book(2, "Spring Boot", 250.00)).collect(Collectors.toList()));
